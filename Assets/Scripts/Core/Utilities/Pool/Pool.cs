...
namespace Core.Utilities
{
		...
		where T : Component
	{
		...
		public override T Get(Action<T> resetOverride)
		{
			...
			UnityEngine.Profiling.Profiler.BeginSample("UnityComponentPool<T>.Get", element);
		...
		{
			UnityEngine.Profiling.Profiler.BeginSample("UnityComponentPool<T>.ReturnToPoolInternal", element);
	...
	public class GameObjectPool : Pool<GameObject>
	{
		...
		public override GameObject Get(Action<GameObject> resetOverride)
		{
			...
			UnityEngine.Profiling.Profiler.BeginSample("GameObjectPool.Get", element);
		...
		{
			UnityEngine.Profiling.Profiler.BeginSample("GameObjectPool.ReturnToPoolInternal", element);
